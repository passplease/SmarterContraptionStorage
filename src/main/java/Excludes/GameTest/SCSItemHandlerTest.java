...
public class SCSItemHandlerTest {
    ...
    public static void testAEController(CreateGameTestHelper helper) {
        ...
        helper.setBlock(new BlockPos(3, 10, 3),AEBlocks.SECURITY_STATION.block());
        SecurityStationBlockEntity securityStationBlockEntity = helper.getBlockEntity(AEBlocks.SECURITY_STATION.block().getBlockEntityType(), new BlockPos(3, 10, 3));
        ...
        AEItemKey linerChassis = AEItemKey.of(AllBlocks.LINEAR_CHASSIS.asStack());
        assert linerChassis != null;
            ...
            for(IPart part : AE2BusBlockHelper.getAllPart(bus)){
                if (part instanceof IOBusPart){
                    ...
                    if (k instanceof AEItemKey key) {
                        ...
                        if(nbt != null) {
                            nbt.putLong("gridKey", securityStationBlockEntity.getSecurityKey());
                            break;
                        }
                    }
